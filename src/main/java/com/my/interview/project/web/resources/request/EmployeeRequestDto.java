...
public class EmployeeRequestDto {
    ...
    @Pattern(regexp = "^CITIZENSHIP ID$|^IMMIGRATION ID$|^PASSPORT$|^SPECIAL PERMIT$",
            flags = Pattern.Flag.CASE_INSENSITIVE,
            message = "Invalid ID Type, should be Citizenship ID, Immigration ID, Passport or Special Permit.")
